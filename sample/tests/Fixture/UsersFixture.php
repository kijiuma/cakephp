...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '0:管理者１：一般ユーザー', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'role' => 1,
                'created' => '2020-05-15 05:18:11',
                'modified' => '2020-05-15 05:18:11',
            ],
        ];
        parent::init();
    }
